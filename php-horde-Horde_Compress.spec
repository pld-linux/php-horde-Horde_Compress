...
# Source0-md5:	47d85cbc7bc3ebd8bd7f6f2db3733213
...
%define		_noautoreq	 pear(Horde/Stream/Filter.*)
...
%{php_pear_dir}/Horde/Compress.php
%{php_pear_dir}/Horde/Compress
%{php_pear_dir}/data/Horde_Compress
